...
export function Failed({ width, height }) {
    return (
        <svg width={width} height={height} viewBox="0 -8 528 528" aria-hidden="true">
            <title>Failed</title>
...
export function Idle({ width, height }) {
    return (
        <svg width={width} height={height} viewBox="-16 0 512 512" aria-hidden="true">
            <title>Queued</title>
...
export function Running({ width, height }) {
    return (
        <svg width={width} height={height} viewBox="0 0 100 100" aria-hidden="true">
            <title>Running</title>
...
export function Success({ width, height }) {
    return (
        <svg width={width} height={height} viewBox="0 0 1920 1920" aria-hidden="true">
